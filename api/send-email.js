...
export default async function handler(req, res) {
  ...
  try {
    ...
    try {
      ...
      // Continuamos aunque la verificación falle, ya que algunos servidores no la soportan
    }
    ...
    console.log('📧 Enviando email desde servidor cPanel:', {
      to: emailData.to,
    ...
    if (error.code === 'EAUTH') {
      ...
      errorDetails = 'Verifica las credenciales de usuario y contraseña';
